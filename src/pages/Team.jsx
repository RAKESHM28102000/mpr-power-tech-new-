...
export default function Team() {
  ...
  return (
    <section className="pt-24 pb-16 bg-[#222831] text-[#EEEEEE] px-4">
      <div className="max-w-7xl mx-auto">

        {/* HEADER */}
        <div className="text-center mb-16">
          <h2 data-aos="fade-down" className="text-3xl md:text-4xl font-bold mb-4">
            Our <span className="text-[#00ADB5]">Team</span>
          </h2>
          <p data-aos="fade-up" className="text-[#EEEEEE]/70 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-20">
          {leaders.map((leader, i) => (
            <a
              ...
              rel="noreferrer"
              data-aos="zoom-in"
              className="bg-[#393E46] rounded-xl shadow-lg overflow-hidden
              hover:shadow-2xl hover:-translate-y-1 transition group"
            >
              <div className="flex flex-col md:flex-row">
                <div className="relative md:w-1/3 h-72">
                  ...
                  />
                  <span className="absolute top-4 left-4 bg-[#00ADB5] text-[#222831] text-xs font-semibold px-3 py-1 rounded-full">
                    {leader.experience}
                  </span>
                </div>
                ...
                <div className="p-6 flex flex-col justify-center">
                  ...
                  <p className="text-[#00ADB5] font-semibold mt-1">
                    {leader.role}
                  </p>
                  <p className="text-[#EEEEEE]/70 mt-4 text-sm leading-6">
                    Leadership backed by decades of experience in engineering,
                    project execution, and team management.
                  </p>

                  <div className="flex gap-4 mt-5 text-xl text-[#EEEEEE]">
                    <FaLinkedin className="hover:text-[#00ADB5] transition" />
                    <FaInstagram className="hover:text-[#00ADB5] transition" />
                  </div>
                </div>
              </div>
            </a>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {members.map((member, i) => (
            <a
              ...
              className="group bg-[#393E46] rounded-xl shadow
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                {/* SOCIAL OVERLAY */}
                <div className="absolute inset-0 bg-[#222831]/80 opacity-0 group-hover:opacity-100 transition flex items-center justify-center gap-4 text-[#EEEEEE] text-xl">
                  <FaLinkedin className="hover:text-[#00ADB5]" />
                  <FaInstagram className="hover:text-[#00ADB5]" />
                </div>
              </div>

              <div className="p-5 text-center">
                <h3 className="text-lg font-semibold">{member.name}</h3>
                <p className="text-sm text-[#EEEEEE]/60 mt-1">{member.role}</p>
              </div>
            </a>
          ))}
        </div>
